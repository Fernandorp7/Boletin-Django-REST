# models.py: Define los modelos de datos para los vehículos y las marcas. Estos modelos especifican
# los campos de los vehículos (tipo, chasis, marca, modelo, matrícula, color, etc.) y las marcas (nombre).
# También incluye opciones de elección para los tipos de vehículos y los colores.
